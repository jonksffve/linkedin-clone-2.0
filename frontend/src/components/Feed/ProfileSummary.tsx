    ...
    return (
        <CardContainer className='p-0'>
            <div className='flex flex-col gap-2'>
                ...
                />
                <div className='p-2'>
                    <Link to={`${ROUTE_PROFILE}${userState.email}`}>
                        <img
                    ...
                    <p className='text-center text-neutral-400 text-sm'>Title description</p>
                </div>
                <hr />
                <div>
                    <Button className='flex flex-row justify-between text-sm w-full rounded-sm hover:bg-neutral-200'>
                        <p>Contactos:</p>
                        <span className='text-blue-500 font-semibold'>{userState.get_following}</span>
                    </Button>
                    <Button className='flex flex-row justify-between text-sm w-full rounded-sm hover:bg-neutral-200'>
                        <p>Invitaciones:</p>
